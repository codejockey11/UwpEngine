...
namespace UwpEngine
{
	...
	public:
		...
		BYTE	signature[18];		/* TGA Signature */
		...
		{
			size_t bytesRead = fread_s(&extensionOffset, sizeof(DWORD), sizeof(DWORD), 1, f);
			bytesRead = fread_s(&developerOffset, sizeof(DWORD), sizeof(DWORD), 1, f);
			bytesRead = fread_s(&signature, sizeof(BYTE) * 18, sizeof(BYTE), 18, f);
		}
	};
	...
	public:
		...
		BYTE  AuthorName[41];         /* Author Name */
		BYTE  AuthorComment[324];     /* Author Comment */
...
// Defining our own image RGB object so undef the Windows version
#undef RGB
	...
	*/
	...
	public:
		...
		{
			size_t bytesRead = fread_s(&count, sizeof(BYTE), sizeof(BYTE), 1, f);
		}
	...
	public:
		...
		{
			size_t bytesRead = fread_s(&value, sizeof(BYTE), sizeof(BYTE), 1, f);
		}
	};
	...
	public:
		...
		void ReadValue(FILE* f)
		{
			size_t bytesRead = fread_s(&value, sizeof(BGR), sizeof(BGR), 1, f);
		}
	};
	...
	public:
		...
		void ReadValue(FILE* f)
		{
			size_t bytesRead = fread_s(&value, sizeof(BGRA), sizeof(BGRA), 1, f);
		}
	};
	...
	public:
		...
		BGR				m_colorTable[256];
		BYTE			m_imageDescription[256];
		int				m_size8;
		int				m_size24;
		int				m_size32;
		BYTE*			m_pixels8;
