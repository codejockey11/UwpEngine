...
namespace UwpEngine
{
	// Provides an interface for an application that owns CVideoDevice to be notified of the device being lost or created.
	...
	public:
		...
		ID3D11BlendState1*			GetBlendState() const					{ return m_blendState.Get(); }
	...
	private:
		...
		// The IDeviceNotify can be held directly as it owns the CVideoDevice.
